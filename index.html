...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="styles.css?v=real-map" />
  </head>
  <body>
      ...
      <section class="finder-section" id="boat-finder" aria-labelledby="finder-title">
        <div class="finder-head">
          ...
          <p>
            ...
            sailing yachts, motor yachts, and day boats. Later this can read live inventory
            from broker APIs.
          </p>
        </div>
        ...
        <form class="finder-search" id="boatFinderForm">
          ...
          <label>
            Guests
            <input name="finderGuests" type="number" min="2" max="14" value="6" />
          </label>
          <label>
            Boat type
    ...
    <script src="script.js?v=real-map"></script>
  </body>
</html>
