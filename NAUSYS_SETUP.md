    ...
    <main id="top">
      ...
      <section class="articles-section" id="articles" aria-labelledby="articles-title">
        <div class="articles-head">
          ...
          <h2 id="articles-title">Articles and tips from the world of yachting</h2>
          <p>
            Read articles about yachting destinations, equipment, boat handling, the marine world,
            attractions, and other activities at sea.
          </p>
        </div>
        <div class="articles-grid">
          <article class="article-card">
            <img
              ...
              alt="Mediterranean seaside town for sailing holiday provisioning"
            />
            <div class="article-body">
              <h3>How to stock up for a sailing holiday</h3>
              <p>Example article about supplies, water, snacks, local markets, and a calm first day on board.</p>
              <a class="button light" href="#articles">More info</a>
            </div>
          </article>
          <article class="article-card">
            <img
              src="https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?auto=format&fit=crop&w=900&q=82"
              alt="Crew preparing for a yacht trip"
            />
            <div class="article-body">
              <h3>How to prepare novices for sailing</h3>
              <p>Example article about briefing guests, packing light, safety basics, seasickness, and crew roles.</p>
              <a class="button light" href="#articles">More info</a>
            </div>
          </article>
          <article class="article-card">
            <img
              src="https://images.unsplash.com/photo-1566933293069-b55c7f326dd4?auto=format&fit=crop&w=900&q=82"
              alt="Sailing yacht under sail in stronger wind"
            />
            <div class="article-body">
              <h3>Typical winds in Greece</h3>
              <p>Example article about choosing between calm Ionian routes and windier Aegean passages.</p>
              <a class="button light" href="#articles">More info</a>
            </div>
          </article>
        </div>
