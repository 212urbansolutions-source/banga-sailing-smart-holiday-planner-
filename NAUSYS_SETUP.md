...
<html lang="en">
  <head>
    ...
    <title>Yacht Details | Sailing Holidays</title>
    <meta
      name="description"
      content="Detailed yacht charter page with live NAUSYS boat information, dates, price, specs, pictures, equipment, and inquiry options."
    />
    <link rel="stylesheet" href="styles.css?v=yacht-detail-inline" />
  </head>
